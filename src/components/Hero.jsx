...
const Hero = () => {
  return (
    <>
      <div className="flex flex-col md:flex-row px-[40px] py-[60px] bg-cover bg-no-repeat bg-center bg-hero-background overflow-hidden">
        <div className="flex flex-1 justify-center items-start flex-col mr-[50px] animate__animated animate__fadeInLeft">
          <h1 className="font-Space text-[40px] md:text-[44px] lg:text-[54px] xl:text-[54px] text-black font-bold leading-[57px]">
            The Best place for designers around the web
          </h1>
          <p className="font-Inter md:text-[20px] lg:text-[20px] sm:leading-normal xl:text-[20px] text-[16px] text-slate-700 font-medium leading-tight mt-[18px] mb-[32px]">
        ...
        <div className="flex flex-1 justify-center items-center animate__animated animate__fadeInRight">
          <img className="w-[70%]" src={heroimage} alt="" />
        </div>
      </div>
      <Features />
      <How_works />
